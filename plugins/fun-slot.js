...
/*await conn.sendHydrated(m.chat, `${s}\n\n${end}`, wm, null, md, 'DavidBotMini', null, null, [
...
/*await conn.sendHydrated(m.chat, `*Elija en que apostará ${apuesta}*`, wm, null, md, 'DavidBotMini', null, null, [
